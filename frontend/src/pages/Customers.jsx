          ...
          {filteredCustomers.length === 0 ? (
            ...
            filteredCustomers.map(cust => {
              ...
              return (
                <div
                  key={cust.id}
                  className={`p-4 rounded-2xl border card-shadow flex flex-col justify-between transition ${theme === 'dark' ? 'bg-slate-800 border-slate-700 text-white' : 'bg-white border-slate-200 text-slate-800'
                    }`}
                >
