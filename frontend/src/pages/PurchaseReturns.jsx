            ...
            <form onSubmit={handleSaveEdit} className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          ...
                          <input
                            ...
                            className={`w-full border rounded-xl px-2.5 py-1 text-xs font-mono font-bold outline-none focus:border-rose-500 ${
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  <label className="text-[11px] font-bold text-slate-400">Total Return / Debit Amount (Rs.) *</label>
                  <span className="text-[10px] font-black text-rose-500 uppercase">Grand Total</span>
                </div>
                <input
                  type="number"
                  required
