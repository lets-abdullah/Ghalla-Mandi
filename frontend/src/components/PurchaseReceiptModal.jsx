    ...
    try {
      ...
      const opt = {
        ...
        html2canvas: { 
          ...
          onclone: (clonedDoc) => {
            const clonedVoucher = clonedDoc.getElementById('purchase-voucher-printable-area');
            if (clonedVoucher) {
              clonedVoucher.style.maxHeight = 'none';
              clonedVoucher.style.overflow = 'visible';
              clonedVoucher.style.height = 'auto';
              clonedVoucher.style.width = '100%';
              clonedVoucher.style.padding = '24px';
              clonedVoucher.style.background = '#ffffff';
              const scrollWrappers = clonedVoucher.querySelectorAll('.overflow-x-auto, .overflow-y-auto');
  ...
  return (
    ...
    >
      ...
      <div 
        ...
        className={`w-full max-w-xl rounded-2xl sm:rounded-3xl card-shadow border overflow-hidden flex flex-col my-auto max-h-[94vh] print:max-h-none print:shadow-none print:border-none print:w-full print:max-w-none print:rounded-none ${
      ...
      >
        ...
        <div
          className="flex-1 overflow-y-auto no-scrollbar p-3.5 sm:p-5 space-y-3 sm:space-y-3.5 text-slate-800 bg-white"
